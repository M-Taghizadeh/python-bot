...
BOT_TOKEN = "5821119327:AAG9ddgr14MYFeZIngOGDMh7w0qyH5s4hyY"
PAYMENT_CHANNEL = "@python_daneshjooyar" #add payment channel here including the '@' sign
OWNER_ID = 265597380 #write owner's user id here.. get it from @MissRose_Bot by /id
CHANNELS = ["@python_daneshjooyar"] #add channels to be checked here in the format - ["Channel 1", "Channel 2"] 
